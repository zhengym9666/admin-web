...
<div id="recruitNewRightWindow" class="right-alert">
	<!---<<<<  弹窗左侧阴影   >>>>-->
	...
	<div class="right-alert-main">
		...
		<div class="right-alert_head" style="padding-bottom:0px;height:140px">
			...
			<span class="right-alert_head_title">查看报名人员信息</span>
		</div>
			...
			<div class="tabs_box">
				<div class="tabs-wapper open">
					<ul class="view-ul clear-fixed">
						...
						<li class="form-items">
							<div class="form-left">
								<span><i class="iconfont icon-bitian"></i>意向部门：</span>
							</div>
							<div class="form-right">
						...
						<li class="form-items">
							<div class="form-left">
								<span><i class="iconfont icon-bitian"></i>意向职位：</span>
							</div>
							<div class="form-right">
						...
						<li class="form-items">
							<div class="form-left">
								<span><i class="iconfont icon-bitian"></i>申请时间：</span>
							</div>
							<div class="form-right">
								<input class="required" id="edit-applyTime" type="text" style="cursor:pointer;caret-color: transparent;"/>
							</div>
						</li>
						<li class="form-items">
							<div class="form-left">
